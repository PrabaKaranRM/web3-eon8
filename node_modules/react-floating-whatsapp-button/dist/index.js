...
var FloatingWhatsApp = function FloatingWhatsApp(_ref) {
  ...
  var isInternetExplorer = function isInternetExplorer() {
    ...
    return userAgent && (userAgent.indexOf('MSIE') >= 0 || userAgent.match(/Trident.*rv:11\./));
  };

  var sendWhatsappMessage = function sendWhatsappMessage() {
    var apilink = 'http://';
    apilink += isMobile() ? 'api' : 'web';
    apilink += '.whatsapp.com/send?phone=' + phone + '&text=' + encodeURI(messageInput);
    window.open(apilink);
  };
  ...
  return React.createElement("div", {
    ...
    className: (openPopup ? styles.active : '') + " " + styles.floatingWppPopup,
  ...
  }, React.createElement("span", null, headerTitle), React.createElement("strong", {
    className: styles.close,
    onClick: function onClick() {
      return setOpenPopup(false);
    }
  }, "\xD7")), React.createElement("div", {
    className: styles.floatingWppMessage
  }, popupMessage), React.createElement("div", {
    className: styles.floatingWppInputMessage
...
exports.FloatingWhatsApp = FloatingWhatsApp;
